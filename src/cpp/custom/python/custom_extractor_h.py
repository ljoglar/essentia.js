[[[cog
   ...
   extractors = {'LogMelSpectrogramExtractor':{'params': 'const int frameSize=1024, const int hopSize=512, ' +
                                                         'const int numBands=96, const std::string& windowType="hann"',
                                               'algorithms': ['FrameCutter', 'Windowing', 'Spectrum', 'MelBands', 'UnaryOperator']
                                               },
                 'SaturationDetectorExtractor':{'params': 'const int frameSize=512, const int hopSize=256' ,
                                                'algorithms': ['FrameCutter', 'SaturationDetection']
                                                }
                 }
